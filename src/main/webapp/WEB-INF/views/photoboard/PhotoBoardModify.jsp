...
<html lang="en">
<head>
<title>teatime</title><meta http-equiv="content-type" content="text/html;charset=UTF-8" />
</head>
...
<form method="post" action="${pageContext.request.contextPath}/photoBoard.modify" enctype="multipart/form-data" onsubmit="return FormSubmit();">
...
<input type="button"  class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/photoBoard.detail?idx=${modify.idx} '" value="취소">
</div>
</form>
...
$(document).ready(function() {
   ...
   function sendFile(file, editor, welEditable) {
       ...
       $.ajax({
           data : data,
           type : "POST",
           url : "${pageContext.request.contextPath}/teatime.photoBoardImageUpload",
           cache : false,
           contentType : false,
           processData : false,
...
function FormSubmit(){
	...
	index2 =$('textarea[name="content"]').val();
	indexfind = index.indexOf('<img');
	indexfind2 = index.indexOf('src="');
