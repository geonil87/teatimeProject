				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-12 col-md-12 content-area">
							...
							<!-- 썸네일 추가 박스 no.1 -->	
							<c:forEach items="${searchList}" var="photolist">														
								<div class="col-lg-4 col-md-6 col-sm-6">
									<div class="type-post">
										<div class="entry-cover">
											<div class="post-meta">
									
												<span class="byline">by <a href="#" title="Indesign">${photolist.user_nick}</a></span>
												<span class="post-date"><a href="#">${photolist.wdate}</a></span>
											</div>
								...
								<a href="#" title="Traffic Jams Solved">${photolist.title}</a></h4>
											</div>								
					...
					<button type="button" class="btn btn-default" id="write" value="글쓰기">글쓰기</button>
							...
							<nav class="navigation pagination">
								...
								<div class="nav-links">
									...
									<input type="button" id="pageNum" class="page-numbers" value="${i }" onclick="location.href='<%=request.getContextPath()%>/photoBoard.search?searchColumn=${searchColumn}&keyword=${keyword }&pageNum=${i}'">
							</c:forEach>
...
$(document).ready(function(){
	...
	$('#next').on('click',function(e){
		...
		if(finalPageNum < pageNum){
			...
			location.href="${pageContext.request.contextPath}/photoBoard.search?searchColumn="+searchColumn+"&keyword="+keyword+"&pageNum="+pageNum;
		}		
	});
