...
<form method="post" action="${pageContext.request.contextPath}/photoBoard.insert" enctype="multipart/form-data" onsubmit="return FormSubmit();">
...
<input type="button"  class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/photoBoard.list'" value="취소">
</div>
</form>
...
$(document).ready(function() {
   ...
   function sendFile(file, editor, welEditable) {
       ...
       $.ajax({
           data : data,
           type : "POST",
           url : "${pageContext.request.contextPath}/photoBoard.imageUpload",
           cache : false,
           contentType : false,
