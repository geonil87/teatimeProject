...
<form id="reportForm" method="post" action="${pageContext.request.contextPath}/photoBoard.report" enctype="multipart/form-data">
...
<input type="button"  class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/photoBoard.detail?idx=${param.idx }'" value="취소">
</div>
</form>
...
function checkReport(idx){
	$.ajax({
		type:"post",
		data:{"idx":idx},
		url:"${pageContext.request.contextPath}/photoBoard.checkReport",
