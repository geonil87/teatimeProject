...
<form id="reportForm" method="post" action="${pageContext.request.contextPath}/mediaBoard.commentReport" enctype="multipart/form-data">
...
<input type="button"  class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/mediaBoard.detail?idx=${param.board_idx }'" value="취소">
</div>
...
function checkReport(idx){
	$.ajax({
		type:"post",
		data:{"idx":idx},
		url:"${pageContext.request.contextPath}/mediaBoard.checkCommentReport",
