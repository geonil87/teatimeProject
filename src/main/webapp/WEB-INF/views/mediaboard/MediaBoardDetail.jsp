...
<a href="${pageContext.request.contextPath }/mediaBoard.report?idx=${detail.idx}&title=${detail.title}"><img src="resources/assets/images/6.PNG" alt="Post Image" /></a>
</div>
</div>
<!-- 신고 이미지 -->
<hr>
...
<button type="button"  class="btn btn-default"  onclick="location.href='${pageContext.request.contextPath}/mediaBoard.list'" value="목록">목록</button>
...
<button type="button" id="delete" class="btn btn-default" value="삭제">삭제</button>
						...
						<a href="${pageContext.request.contextPath }/mediaBoard.commentReport?board_idx=${best.board_idx}&comment_idx=${best.idx}&content=${best.content}"><i class="fa fa-bell-o" aria-hidden="true fa-lg"></i>신고</a>&nbsp;&nbsp;&nbsp;
						...
						2. 베스트 댓글 <i class="fa fa-diamond" aria-hidden="true"></i><b class="fn" style="text-transform:lowercase">  <br><br>
						<i class="fa fa-user-o" aria-hidden="true"></i> by 구하라</b> <a href="#">2017.11.16:21:01</a><br><br>
						<i class="fa fa-volume-up" aria-hidden="true"></i> 20대 후반인 저도싫어요..<br><br>
						<span class="commentGood"><a href='#' ><i class="fa fa-thumbs-up fa-lg" aria-hidden="true"></i>추천</a> <input type="hidden" value=""></span><span class="commentGoodValue">(331)&nbsp;&nbsp;&nbsp;</span>
						<span class="commentBad"><a href='#' ><i class="fa fa-thumbs-down fa-lg" aria-hidden="true"></i>비추천</a> <input type="hidden" value=""></span><span class="commentBadvalue">(111)&nbsp;&nbsp;&nbsp;</span>
						<a href="#"><i class="fa fa-bell-o" aria-hidden="true fa-lg"></i>신고</a>&nbsp;&nbsp;&nbsp;
						<i class="fa fa-trash-o fa-lg" aria-hidden="true"></i>삭제&nbsp;&nbsp;&nbsp;
						<i class="fa fa-pencil-square-o" aria-hidden="true"></i>글수정&nbsp;&nbsp;&nbsp;
						<i class="fa fa-commenting-o" aria-hidden="true"></i>댓글달기
						</div>
						<hr>
												<div class="comments-area">
						3. 베스트 댓글 <i class="fa fa-diamond" aria-hidden="true"></i><b class="fn" style="text-transform:lowercase">  <br><br>
						<i class="fa fa-user-o" aria-hidden="true"></i> by 설리</b> <a href="#">2017.11.16:21:01</a><br><br>
						<i class="fa fa-volume-up" aria-hidden="true"></i> 웬 은...? 고등학생커플도 아니고<br><br>
						<span class="commentGood"><a href='#' ><i class="fa fa-thumbs-up fa-lg" aria-hidden="true"></i>추천</a> <input type="hidden" value=""></span><span class="commentGoodValue">(331)&nbsp;&nbsp;&nbsp;</span>
						<span class="commentBad"><a href='#' ><i class="fa fa-thumbs-down fa-lg" aria-hidden="true"></i>비추천</a> <input type="hidden" value=""></span><span class="commentBadvalue">(111)&nbsp;&nbsp;&nbsp;</span>
						<a href="#"><i class="fa fa-bell-o" aria-hidden="true fa-lg"></i>신고</a>&nbsp;&nbsp;&nbsp;
						<i class="fa fa-trash-o fa-lg" aria-hidden="true"></i>삭제&nbsp;&nbsp;&nbsp;
						...
						<hr> -->
								...
								<c:if test="${comment.indent==0}">
										<div class="comment-body">
											...
											<c:if test="${comment.available==0}">
												...
												<a href="${pageContext.request.contextPath }/mediaBoard.commentReport?board_idx=${detail.idx}&comment_idx=${comment.idx}&content=${comment.content}"><i class="fa fa-bell-o" aria-hidden="true fa-lg"></i>신고</a>&nbsp;&nbsp;&nbsp;
											</c:if>
									<!-- 삭제 -->
											<c:if test="${comment.available==0}">
											<a class="commentDelete" href="${pageContext.request.contextPath}/mediaBoard.commentDelete?idx=${comment.idx}&board_idx=${detail.idx}"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i>삭제<input type="hidden" value="${comment.idx }"></a>&nbsp;&nbsp;&nbsp;
											</c:if>
									<!-- 삭제 -->	
										<!-- 댓글수정 -->
										<c:if test="${comment.available==0}">
											<i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;<a href='javascript:void(0)' onclick="this.innerHTML=(this.nextSibling.style.display=='none')?'취소':'댓글수정';this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none'">댓글수정</a><DIV style='display:none'>				
												<div class="comment-respond">
													...
													<form method="post" class="comment-form" action="${pageContext.request.contextPath}/mediaBoard.commentModify">
							...
							&nbsp;&nbsp;<i class="fa fa-commenting-o" aria-hidden="true"></i>&nbsp;<a href='javascript:void(0)' onclick="this.innerHTML=(this.nextSibling.style.display=='none')?'취소':'댓글달기';this.nextSibling.style.display=(this.nextSibling.style.display=='none')?'block':'none'">댓글달기</a><DIV style='display:none'>				
								<div class="comment-respond">
									...
									<form method="post" class="comment-form" action="${pageContext.request.contextPath}/mediaBoard.reCommentInsert">
										<p class="comment-form-author">
												...
												<div class="comment-body">
													<footer class="comment-meta">
														...
														<img src="${pageContext.request.contextPath}/resources/assets/images/567.PNG">	
															<b class="fn"><i class="fa fa-user-o" aria-hidden="true"></i> by ${comment.user_nick}</b>
														</div>
														<div class="comment-metadata">
															<a>${comment.wdate}</a>											
														</div>
		...
		<!-- 												댓글수정 -->
                        ...
                        <div class="comment-respond">
                           <h2 class="comment-reply-title">댓글 쓰기</h2>
                           <form method="post" class="comment-form" action="${pageContext.request.contextPath}/mediaBoard.commentInsert">
                              <p class="comment-form-author">
                                 <input type="hidden" name="board_idx" value="${detail.idx }">                                 
                              </p>
                              <p class="comment-form-comment">
...
$(document).ready(function(){
	...
	$('#modify').on('click',function(){
		...
		var idx = "${detail.idx }";
		var permission = "${sessionPermission}";
		var locationPath="${pageContext.request.contextPath}/mediaBoard.modify?idx=${param.idx}";
		if(id==""){		
			alert("로그인을 해주세요");			
	...
	$('#delete').on('click',function(){
		var id = "${sessionId}";
		var permission = "${sessionPermission}";
		var locationPath = "${pageContext.request.contextPath}/mediaBoard.delete?idx=${param.idx}";
		var idx = ${detail.idx };
		if(id==""){		
			alert("로그인을 해주세요");			
		}else if(permission=="0"){		
	...
	$('.commentDelete').on('click',function(e){
		...
		var permission = "${sessionPermission}";
		var comment_idx = $(this).children(':hidden').val();
		var locationPath = "${pageContext.request.contextPath}/mediaBoard.commentDelete?idx="+comment_idx+"&board_idx=${detail.idx}";
		if(id==""){
			alert("로그인을 해주세요");			
		}else if(permission=="0"){		
			location.href=locationPath;				
...
function recommend(recommend,idx){
	$.ajax({
		...
		url:"<%= request.getContextPath()%>/mediaBoard.recommend",
...
function commentRecommend(recommend,idx,goodLocation,badLocation){
	$.ajax({
		type:"post",
		data:{"recommend":recommend,"idx":idx},
		url:"<%= request.getContextPath()%>/mediaBoard.commentRecommend",
		success:function(result){
 			console.log(result); 			
...
function checkWriter(idx,locationPath){
	$.ajax({
		type:"post",
		data:{"idx":idx},
		url: "${pageContext.request.contextPath}/mediaBoard.checkWriter",
		success:function(result){			
			if(result==1){				
				location.href=locationPath;
			}else{
...
function checkCommentWriter(idx,locationPath){
	$.ajax({
		type:"post",
		data:{"idx":idx},
		url:"${pageContext.request.contextPath}/mediaBoard.checkCommentWriter",
		success:function(result){
			if(result==1){
				location.href= locationPath ;
			}else{
