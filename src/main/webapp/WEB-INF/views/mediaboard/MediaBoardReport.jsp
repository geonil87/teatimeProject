...
<html>
<head>
<title>TEA :: TIME</title><meta http-equiv="content-type" content="text/html;charset=UTF-8" />
</head>
...
<form id="reportForm" method="post" action="${pageContext.request.contextPath}/mediaBoard.report" enctype="multipart/form-data">
...
<tr><td style="text-align: center;">게시물 신고 [ ${param.title } ]</td></tr>
...
<input type="button"  class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/mediaBoard.detail?idx=${param.idx }'" value="취소">
 </div>
...
function checkReport(idx){
	$.ajax({
		type:"post",
		data:{"idx":idx},
		url:"${pageContext.request.contextPath}/mediaBoard.checkReport",
