						...
						<!-- 상단 썸네일 상자 no.1 -->
							<c:if test="${status.index==0 }">
								...
								<img src="http://i.ytimg.com/vi/${bestlist.media}/0.jpg" alt="Slider" style="height: 500px; width: 1170px;"/>
									<div class="carousel-caption">
									<h3><a href="${pageContext.request.contextPath}/mediaBoard.detail?idx=${bestlist.idx}" title="${bestlist.title}">${bestlist.title}</a></h3>
			...
			<div class="container-fluid no-left-padding no-right-padding page-content">
				...
				<div class="container">
					<div class="row">
						...
						<c:forEach items="${allMediaboardlist}" var="medialist">
...
$(document).ready(function(){
	...
	$('#next').on('click',function(e){
		...
		if(finalPageNum < pageNum){
			...
			location.href="${pageContext.request.contextPath}/mediaBoard.list?pageNum="+pageNum; 
		}		
	});
