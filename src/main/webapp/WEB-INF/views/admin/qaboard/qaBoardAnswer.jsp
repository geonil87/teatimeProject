...
<%@ include file="../include/adminHeader.jsp" %>
			...
			<div class="row-fluid">
				...
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="${pageContext.request.contextPath}/qaBoard.answer" method="post">
							<fieldset>
								...
								<div class="control-group">
									...
									<div class="controls">
										<span class="input-xlarge uneditable-input">${sessionScope.sessionNick}</span>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">제목</label>
									<div class="controls">
										<span class="input uneditable-input" style="width: 800px;">[re:] ${question.title}</span>
									</div>
								</div>
								...
								<input type="hidden" name="title" value="[re:] ${question.title}" /> 
								<input type="hidden" name="qaGroup" value="${question.qaGroup}" /> 
