...
<!-- 언어 반응형 -->
	...
	<!-- Standard Favicon -->
	<link rel="icon" type="image/x-icon" href="${pageContext.request.contextPath}/resources/assets/images/favicon.ico" />
							...
							<ul class="top-right user-info">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										...
										<c:when test="${sessionScope.sessionPermission == 1}">
					...
					<div class="row justify-content-md-center">
						<div class="col-md-8">
							<div class="error-block">
								...
								<a href="${pageContext.request.contextPath }/main" title="Back Home">메인페이지</a>
							</div>
						</div>
					</div>
				</div><!-- Container /- -->
