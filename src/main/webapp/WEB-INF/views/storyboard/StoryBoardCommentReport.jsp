...
<form id="reportForm" method="post" action="${pageContext.request.contextPath}/storyBoard.commentReport" enctype="multipart/form-data">
...
<input type="button"  class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/storyBoard.detail?idx=${param.board_idx }'" value="취소">
</div>
...
function checkReport(idx){
	$.ajax({
		type:"post",
		data:{"idx":idx},
		url:"${pageContext.request.contextPath}/storyBoard.checkCommentReport",
...
<!-- 스크롤 -->
<a class="return-top" href="#" style="right:15px; bottom:15px; position:fixed; z-index:9999;"><img src="${pageContext.request.contextPath}/resources/assets/images/scroll.png"></a>
<!-- 스크롤 -->
</body>
