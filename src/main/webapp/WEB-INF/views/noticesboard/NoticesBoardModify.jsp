...
<body>
<div class="Container">
		<h1 class="widget-title" style="font-size: 25px">공지사항 수정하기</h1>
								<hr style="border: 0; height: 1px; background: #ccc;">
<form method="post" action="${pageContext.request.contextPath}/noticesBoard.modify" enctype="multipart/form-data" onsubmit="return FormSubmit();">
...
<tr><td><input type="text" class="form-control" placeholder="제목" name="title" maxlength="50" value="${modify.title}"></td></tr>
<tr><td>
...
<tr><td><textarea class="form-control" id="summernote" placeholder="내용" name="content" maxlength="1000"  style="height: 350px;" >${modify.content}</textarea></td></tr>
...
<div align="right">
<input type="hidden" value="${modify.idx }" name="idx"/>
