			...
			<div class="term">
				...
				<table class="table table-bordered" style="border: 1px solid black;">
					<tbody class="termTable" style="text-align: center; vertical-align: middle;">
						<tr>
							<th style="text-align: center; vertical-align: middle;" width="100px">문의 제목</th>
							<td>${question.title }</td>
						</tr>
						<tr>
							<th style="text-align:center; vertical-align: middle;" height="300px" width="100px">문의 내용</th>
							<td style="text-align: left;" height="300px">${question.content }</td>
						</tr>
					</tbody>
				</table>
			</div>
