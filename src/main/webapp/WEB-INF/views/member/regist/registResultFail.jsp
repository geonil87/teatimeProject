				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-12 content-area">
							...
							<div><img src="${pageContext.request.contextPath}/resources/customImage/cof.gif"></div><img src="${pageContext.request.contextPath}/resources/customImage/22.JPG"><br>
		<br>
		<h3>[${errorMsg}]</h3>
		<br><br><br>
<div align="center">
<input type="button" class="btn btn-default" value="로그인 " onclick="location.href='${pageContext.request.contextPath}/member.login'">
<input type="button" class="btn btn-default" value="메인으로 가기 " onclick="location.href='${pageContext.request.contextPath}/main'">
<input type="button" class="btn btn-default" value="뒤로가기" onclick="javascript:history.back()">
</div>
