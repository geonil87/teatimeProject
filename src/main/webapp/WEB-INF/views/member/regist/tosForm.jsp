...
<html>
  ...
  <title>TEA :: TIME</title>
  	  	<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/customcss/checkbox.css">  
	...
	p{ font-size: small; }
	h6{ font-size: small; }
	.termContent{overflow-y:scroll; height:250px; border-style: solid; border-width: thin; border-color: #BDBDBD; padding: 10px;}
	.termTitle{font-size: small;}
	.table-bordered th{ font-size: small; background-color: #E0E0E0; text-align: center; border: 1px solid #BDBDBD;}
	.table-bordered td{ font-size: small; border: 1px solid #BDBDBD; color:#424242; }
	</style>
	<!--[if lte IE 8]> <script src="${pageContext.request.contextPath }/resources/etc/poly-checked.min.js"></script> <![endif]-->
	...
	<div class="main-container">
			<div class="container-fluid">
				...
				<div class="container">
					...
					<div class="row">
						<!-- Content Area -->
						<div class="col-sm-12 content-area"><br><br>
						<h1 class="widget-title" style="font-size: 25px">약관 동의</h1>
						<hr style="border: 0; height: 1px; background: #ccc;">
							<div class="aboute-block">
					
										<!-- 회원가입 페이지 -->
										<form action="${pageContext.request.contextPath}/member.regist" method="get" id="termForm">
										
										    <div class="termNotice" style="padding-top: 20px;margin-top:-19px; font-size: small;">
										    	회원가입을 위해 서비스 이용 약관 및 개인정보 수집 및 이용 안내 동의가 필요합니다.
										    </div>
											<hr>
											<div class="term">
												<label class="termTitle"><strong>[필수] 서비스 이용 약관</strong></label>
												<div class="termContent">
													<h6><strong>제 1 장 총 칙</strong></h6>
													<h6>제 1 조 (목적)</h6>
											 		<p>										
													이 약관은 TEA::TIME (이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.
													</p>
													...
													<h6><strong>제 2 장 서비스 이용계약</strong></h6>
													<h6>제 4 조 (이용계약의 성립)</h6>
													<p>
													...
													<h6><strong>제 4 장 서비스 제공 및 이용</strong></h6>
													<h6>제 10 조 (회원 아이디(ID)와 비밀번호 관리에 대한 회원의 의무)</h6>
													<p>
													...
													<h6>[부칙]</h6>
													<p>
													(시행일) 이 약관은 2017년 11월부터 시행합니다.<br>
													</p>
												</div>
												<br>
												<div class="checks etrans" align="right">
												  <input type="checkbox" class="termCheck" id="termCheck1" name="termCheck1"> 
												  <label for="termCheck1">서비스 이용약관에  동의합니다. </label> 
												</div>
											</div>
											<hr>
											<div class="term">
												<label class="termTitle"><strong>[필수] 개인정보 수집 및 이용동의</strong></label>
												<table class="table table-bordered" style="border: 1px solid black;">
													<tbody class="termTable">
														<tr>
															<th style="width: 40%">목적</th>
											...
											<p style="margin: auto;">* 개인정보 수집 및 이용에 대해서는 거부할 수 있으며, 거부 시에는 회원가입이 불가합니다.</p>
											<p style="margin: auto;">* 서비스 제공을 위해서 반드시 필요한 최소한의 개인정보이므로 동의를 하셔야 서비스 이용이 가능합니다.</p>
											<p style="margin: auto;">* 이 외 서비스 이용과정에서 별도 동의를 통해 추가정보 수집이 있을 수 있습니다.</p>
											<p style="margin: auto;">* 보안 담당자 : 최형우 대리</p>
											<div class="checks etrans" align="right">
												  <input type="checkbox" class="termCheck" id="termCheck2" name="termCheck2"> 
												  <label for="termCheck2">개인정보 수집 및 이용에 동의합니다.</label> 
											</div>
											<hr>
											<div class="checks etrans" align="right">
												  <input type="checkbox" id="termAllCheck"> 
												  <label for="termAllCheck">서비스 이용약관, 개인정보 수집 및 이용에 <b>모두 동의</b>합니다.</label> 
											</div>
										    <div align="right"><button class="btn btn-default" type="submit">동의</button>   <button class="btn btn-default" type="button" onclick="javascript:history.back()">취소</button></div> 
...
<script>
	...
	$(function(){
	    $("#termForm").validate({
	    	...
	    	rules: {
				termCheck1 : {required: true},
				termCheck2 : {required: true}
				
			},
			
			messages : {
				
				termCheck1 : {	required : '서비스 이용 약관이 체크되지 않았습니다.'	},
				termCheck2 : {	required : '개인정보 수집 및 이용 동의가 체크되지 않았습니다.'	}
			}	
	...
	$("#termAllCheck").click(function(){ 
		if($("#termAllCheck").prop("checked")===true) { 
