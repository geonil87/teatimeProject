...
public class MediaBoardCommentDTO {
	...
	public MediaBoardCommentDTO(int idx, int board_idx, String content, String user_id, String user_nick, String wdate,
